...
export function DestinationCard({ destination }: { destination: Destination }) {
  ...
  return (
    ...
    >
      ...
      <span className="absolute right-4 top-4 grid h-9 w-9 place-items-center rounded-full bg-white/15 text-white opacity-0 backdrop-blur transition-all duration-300 group-hover:opacity-100">
